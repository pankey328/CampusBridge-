          ...
          {!loading && drives.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {drives.map((drive) => (
                <div
                  key={drive._id}
                  className="bg-[#112240] border border-gray-800 rounded-xl p-5 hover:border-[#00ED64]/50 transition-all group flex flex-col"
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-white group-hover:text-[#00ED64] transition-colors">
                          {drive.title}
                        </h3>
                  ...
                  {drive.status === "REJECTED" && drive.rejectionReason && (
                    <div className="mb-4 bg-red-500/10 border-l-4 border-red-500 p-3 rounded-r-lg">
                        ...
                        {drive.status === "ACTIVE" &&
                          new Date(drive.deadline) < new Date() && (
                            <button
                              ...
                              className="px-3 py-1 text-xs font-bold rounded bg-blue-500/20 text-blue-400 hover:bg-blue-500/30"
                            >
                              Mark as Completed
                            </button>
                          )}
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-[#0A192F] p-4 rounded-xl border border-gray-800">
                  ...
                  <p className="font-semibold text-[#00ED64]">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {viewDrive.rounds.map((round, idx) => (
                      <div
                        key={idx}
                        className="bg-[#0A192F] p-4 rounded-xl border border-gray-800 flex flex-col md:flex-row md:items-center"
                      >
